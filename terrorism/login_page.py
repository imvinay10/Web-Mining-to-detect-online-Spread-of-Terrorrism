...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Log In to Terrorism Analysis system")
        ...
        self.bg_img = ImageTk.PhotoImage(file="img.jpg")
        ...
        self.frame3.place(x=450,y=150,width=500,height=450)
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost",user="root",password="1234",database="student_database")
