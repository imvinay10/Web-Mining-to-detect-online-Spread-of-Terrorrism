...
from ttkthemes import ThemedStyle  
                 ...
                 # module to use in-built GUI themesrr
...
class Startpage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        img=ImageTk.PhotoImage(Image.open(r'D:\terrorism (2)\terrorism\wallpaper.jpg').resize((1200,700)))   # set the home page image
        img.image = img
...
class PageOne(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        j=[]
        f = open(r'C:\Users\niles\Downloads\terrorism\keywords.txt')
        for line in f:
            j.append(line.strip())
        f.close()
        d = dict.fromkeys(j,0)
...
class PageTwo(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ttk.Label(self,text="Code by:- @Nilesh,@Vinay,@Prayag,@Omkar",font=(20)).pack()                        # copyright
...
# set app icon
icon = ImageTk.PhotoImage(Image.open(r'D:\terrorism (2)\terrorism\icon.jpg'))
